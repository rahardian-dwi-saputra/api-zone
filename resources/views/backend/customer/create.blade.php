                    	...
                    	<div class="col-lg-8">
                    		...
                    		<form action="/datacustomer" method="post">
                    			...
                    			<div class="form-group row @error('nama') has-error @enderror">
    									...
    									<div class="col-sm-9">
      									<input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Customer" autofocus value="{{ old('nama') }}" autocomplete="off">
                                 @error('nama')
                                 ...
                                 @enderror
  									...
  									<div class="form-group row @error('nomor_telepon') has-error @enderror">
    									...
    									<div class="col-sm-3">
      									<input type="text" class="form-control" id="nomor_telepon" name="nomor_telepon" placeholder="Nomor Telepon" value="{{ old('nomor_telepon') }}" autocomplete="off">
      									@error('nomor_telepon')
                                    <small class="form-text text-danger">
                                       {{ $message }}                               
                                    </small>
                                 @enderror
  									...
  									<div class="form-group row @error('email') has-error @enderror">
    									...
    									<div class="col-sm-5">
      									<input type="email" class="form-control" id="email" name="email" placeholder="Email" value="{{ old('email') }}" autocomplete="off">
                                 @error('email')
                                    <small class="form-text text-danger">
                                       {{ $message }}                               
                                    </small>
