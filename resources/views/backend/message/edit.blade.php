                  ...
                  <div class="row">
                    	<div class="col-lg-8">
                           ...
                           <div class="form-group row @error('type_message') has-error @enderror">
                              ...
                              <div class="col-sm-9">
                                 <input type="text" class="form-control" id="type_message" name="type_message" placeholder="Type Pesan" autofocus value="{{ old('type_message', $data->type_message) }}">
                                 @error('type_message')
                              ...
                              <div class="col-sm-9">
                                 <input id="message" type="hidden" name="message" value="{{ old('message', $data->message) }}">
